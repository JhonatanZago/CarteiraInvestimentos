...
- [ ] 3.3 Upgrade the portfolio position table with search, market/class/result filters, supported ordering, pagination, freshness labels, and backend-provided values; verify interactions request the expected backend query and render the returned page.
...
- [ ] 4.3 Run the Angular frontend with the Spring Boot backend and perform browser smoke flows for dashboard, portfolio filtering, quotation freshness, and unavailable insight states; verify no CORS, console, or HTTP integration errors.
